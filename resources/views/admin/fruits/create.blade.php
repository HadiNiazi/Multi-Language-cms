                        ...
                        <div class="col">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input type="text" name="title_1" value="{{ old('title_1') }}" class="form-control"
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input type="text" name="heading_title_1" value="{{ old('heading_title_1') }}"
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <textarea id="heading_description_1" name="heading_description_1" cols="10" rows="3" class="form-control"
                                        placeholder="Enter description">{{ old('heading_description_1') }}</textarea>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="title">Title</label> <span class="star-color">*</span>
                                    <input type="text" name="title_2" value="{{ old('title_2') }}" class="form-control"
                                        placeholder="Enter title">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="title">Heading Title</label> <span class="star-color">*</span>
                                    <input type="text" name="heading_title_2" value="{{ old('heading_title_2') }}"
                                        class="form-control" placeholder="Enter Heading title">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <textarea id="heading_description_2" name="heading_description_2" cols="10" rows="3" class="form-control"
                                        placeholder="Enter description">{{ old('heading_description_2') }}</textarea>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="title">Title</label> <span class="star-color">*</span>
                                    <input type="text" name="title_3" value="{{ old('title_3') }}" class="form-control"
                                        placeholder="Enter title">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="title">Heading Title</label> <span class="star-color">*</span>
                                    <input type="text" name="heading_title_3" value="{{ old('heading_title_3') }}"
                                        class="form-control" placeholder="Enter Heading title">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <textarea id="heading_description_3" name="heading_description_3" cols="10" rows="3" class="form-control"
                                        placeholder="Enter description">{{ old('heading_description_3') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        ...
                                        <option value="1" @selected(old('status') == 1)>In Progress</option>
                                        <option value="2" @selected(old('status') == 2)>Completed</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3" id="visibilty_div">
                                <div class="col">
                                    ...
                                    <select name="is_visible" class="form-control">
                                        <option value="" disabled selected>Choose Option</option>
                                        <option value="0" @selected(old('is_visible') == 0)>No</option>
                                        <option value="1" @selected(old('is_visible') == 1)>Yes</option>
                                    </select>
                                </div>
                            </div>
