...
#fruits-table th, #fruits-table td {
    border: 1px solid #ddd;
    padding: 10px;
    text-align: center;
}

#fruits-table tr:nth-child(even) {
...
.dataTables_wrapper .dataTables_filter input:focus  {
    outline: none; /* Remove the outline (typically a blue border) on focus */
}
...
/* align datatable pagination in center */
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="{{ asset('assets/site/img/doctors/doctors-1.jpg') }}" class="img-fluid" alt=""></div>
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="{{ asset('assets/site/img/doctors/doctors-2.jpg') }}" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Sarah Jhonson</h4>
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="{{ asset('assets/site/img/doctors/doctors-3.jpg') }}" class="img-fluid" alt=""></div>
              <div class="member-info">
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="{{ asset('assets/site/img/doctors/doctors-4.jpg') }}" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Amanda Jepson</h4>
